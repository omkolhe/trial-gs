...
int getSatEle(string s) {/*	
	...
	*/
	...
	char ele[3]; //= '' #will give slant range
	//lat = ''
	//lon = ''
	int i = 0; //#iterator
	int qty_count = 1; //#if this variable has value i, it means the ith quantity is being accessed
	int j=0;
	int output = 0;
	...
	//now j represents no of digits in elevation

	for (int iter=0; iter<j; iter++){
		output = output*10 + ele[iter] - '0';
	}
...
int getSatAzi(string s) {	/*
	...
	char azi[3];// #will give slant range
	//lat = ''
	//lon = ''
	int i = 0; //#iterator
	int qty_count = 1; //#if this variable has value i, it means the ith quantity is being accessed
